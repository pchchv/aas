...
func (d *MsSQLDB) CreateUserAttribute(tx *sql.Tx, userAttribute *models.UserAttribute) error {
	...
	userAttributeStruct := sqlbuilder.NewStruct(new(models.UserAttribute)).For(sqlbuilder.SQLServer)
...
func (d *MsSQLDB) UpdateUserAttribute(tx *sql.Tx, userAttribute *models.UserAttribute) error {
	return d.CommonDB.UpdateUserAttribute(tx, userAttribute)
}

func (d *MsSQLDB) GetUserAttributeById(tx *sql.Tx, userAttributeId int64) (*models.UserAttribute, error) {
	return d.CommonDB.GetUserAttributeById(tx, userAttributeId)
}

func (d *MsSQLDB) GetUserAttributesByUserId(tx *sql.Tx, userId int64) ([]models.UserAttribute, error) {
	return d.CommonDB.GetUserAttributesByUserId(tx, userId)
}

func (d *MsSQLDB) DeleteUserAttribute(tx *sql.Tx, userAttributeId int64) error {
