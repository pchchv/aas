...
func (d *MsSQLDB) CreateRedirectURI(tx *sql.Tx, redirectURI *models.RedirectURI) error {
	...
	redirectURIStruct := sqlbuilder.NewStruct(new(models.RedirectURI)).For(sqlbuilder.SQLServer)
...
func (d *MsSQLDB) GetRedirectURIById(tx *sql.Tx, redirectURIId int64) (*models.RedirectURI, error) {
	return d.CommonDB.GetRedirectURIById(tx, redirectURIId)
}

func (d *MsSQLDB) GetRedirectURIsByClientId(tx *sql.Tx, clientId int64) ([]models.RedirectURI, error) {
	return d.CommonDB.GetRedirectURIsByClientId(tx, clientId)
}

func (d *MsSQLDB) DeleteRedirectURI(tx *sql.Tx, redirectURIId int64) error {
